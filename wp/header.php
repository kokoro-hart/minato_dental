...
<head>
  ...
  <meta property="og:image" content="<? echo esc_url(get_template_directory_uri()); ?>/img/common/mv01.jpeg">
            ...
            <ul class="p-global-nav__list">
              <li class="p-global-nav__item">
                <a href="<?php echo esc_url(home_url('/')); ?>" class="p-global-nav__link <?php if(is_front_page()) echo 'is-current' ?>">
                  <svg class="c-svg p-global-nav__icon" width="24" height="24">
                    <use xlink:href="<?php echo esc_url(get_template_directory_uri()); ?>/img/svg/sprite.min.svg#icon-home" />
                  </svg>
                  <span class="p-global-nav__text">
                    ホーム
                  </span>
                  <svg class="c-svg p-global-nav__arrow-right u-hidden-xl-up" width="14" height="14">
                    <use xlink:href="<?php echo esc_url(get_template_directory_uri()); ?>/img/svg/sprite.min.svg#icon-right" />
                  </svg>
                </a>
              </li>
              <li class="p-global-nav__item">
                <a href="<?php echo esc_url(home_url('/about')); ?>" class="p-global-nav__link <?php check('about');?>">
                  <svg class="c-svg p-global-nav__icon" width="24" height="24">
                    <use xlink:href="<?php echo esc_url(get_template_directory_uri()); ?>/img/svg/sprite.min.svg#icon-about" />
                  </svg>
                  <span class="p-global-nav__text">
                    当院について
                  </span>
              ...
              <li class="p-global-nav__item">
                <a href="<?php echo esc_url(home_url('/medical')); ?>" class="p-global-nav__link <?php check('medical');?>">
                  <svg class="c-svg p-global-nav__icon" width="24" height="24">
                    <use xlink:href="<?php echo esc_url(get_template_directory_uri()); ?>/img/svg/sprite.min.svg#icon-medical" />
                  </svg>
                  <span class="p-global-nav__text">
                    診察案内
                  </span>
              ...
              <li class="p-global-nav__item">
                <a href="<?php echo esc_url(home_url('/staff')); ?>" class="p-global-nav__link <?php check('staff');?>">
                  <svg class="c-svg p-global-nav__icon" width="24" height="24">
                    <use xlink:href="<?php echo esc_url(get_template_directory_uri()); ?>/img/svg/sprite.min.svg#icon-staff" />
                  </svg>
                  <span class="p-global-nav__text">
                    スタッフ紹介
                  </span>
              ...
              <li class="p-global-nav__item">
                <a href="<?php echo esc_url(home_url('/blog')); ?>" class="p-global-nav__link <?php if(is_home() || is_category() || is_single() || is_archive()) echo 'is-current' ?>">
                  <svg class="c-svg p-global-nav__icon" width="24" height="24">
                    <use xlink:href="<?php echo esc_url(get_template_directory_uri()); ?>/img/svg/sprite.min.svg#icon-blog" />
                  </svg>
                  <span class="p-global-nav__text">
                    ブログ・お知らせ
                  </span>
