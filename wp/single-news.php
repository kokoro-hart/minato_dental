    ...
    <main>
      ...
      <section class="p-lower-mv">
        <picture class="p-lower-mv__picture">
          ...
          <img src="<?php echo esc_url(get_template_directory_uri());  ?>/img/common/mv-blog_pc.jpeg" class="p-lower-mv__img" media="(min-width: 768px)" decoding="async" alt="スタッフブログ">
        </picture>
              ...
              <?php if ($next_post) : ?>
                <div class="prev page-numbers">
                  ...
                  <svg class="c-svg c-pagination__arrow c-pagination__arrow--prev" width="16" height="16">
                    <use xlink:href="<?php echo esc_url(get_template_directory_uri());  ?>/img/svg/sprite.min.svg#arrow-next" />
                  </svg>
              ...
              <?php if ($prev_post) : ?>
                <div class="next page-numbers">
                  ...
                  <svg class="c-svg c-pagination__arrow c-pagination__arrow--next" width="16" height="16">
                    <use xlink:href="<?php echo esc_url(get_template_directory_uri());  ?>/img/svg/sprite.min.svg#arrow-prev" />
                  </svg>
